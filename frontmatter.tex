...
\renewcommand{\subsectionmark}[1]{%
  \markright{\MakeUppercase{\thesubsection\ \ \ \sectiontitle\ ·\ }{\itshape #1}}}%
}
...
\parbox{0.27cm}{\Large{``}}{\small{\textquotefont{{#1}}}}$\,$\parbox{0.25cm}{\Large{''}} \vspace{-1.30em}\flushright{\small{\textquotefont{{#2}}}}
\end{quote}\end{center}
\vspace{-0.40em}
}
\newcommand{\basicquote}[1]{
\begin{center}\begin{quote}
\parbox{0.27cm}{\Large{``}}{\small{\textquotefont{{#1}}}}$\,$\parbox{0.25cm}{\Large{''}}
\end{quote}\end{center}
}
...
\newcommand{\mycirc}[1][black]{\,\tikz\draw[#1,fill=#1] (0,0) circle (.7ex);}
